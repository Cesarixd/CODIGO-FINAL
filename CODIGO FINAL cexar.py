...
big_font = pygame.font.SysFont("comicsansms", 70) # <-- CAMBIO AÑADIDO: Fuente para el título 'GAME OVER'
...
def game_loop():
    ...
    while not game_over:
        ...
        # <-- INICIO DEL CAMBIO: Bucle de 'Game Over' reestructurado para centrado
        while game_close:
            screen.fill(negro) # Fondo negro o el color que prefieras (antes era azul)
            ...
            # --- INSTRUCCIONES (Letras Pequeñas, debajo) ---
